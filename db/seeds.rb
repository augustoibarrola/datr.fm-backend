...
# User.create(name: "Augusto", age: 24, username: "Otsugua", lastfm_username: "OtsuguaalorrabI", spotify_username: "",  email: "augusto@email.com", description: "Cheap date", image_url: image_stock.sample, password: "hello")

# User.create( name: "Anastasia", age: 23, username: "KittyGirl", lastfm_username: "", spotify_username: "", email: "anastasia@hotmail.com", description: "Street cat running from heartache", image_url: image_stock.sample, password: "hello")

# 10.times do 
# User.create(name: Faker::Artist.unique.name, age: rand(21...45), username: Faker::Internet.unique.username, lastfm_username: "", spotify_username: "", email: Faker::Internet.unique.free_email, description: Faker::Dessert.flavor, image_url: image_stock.sample, password: "hello" )
# end
...
15.times do 
    User.create(name: Faker::Name.unique.name_with_middle, age: rand(21...65), username: Faker::Internet.unique.username, lastfm_username: "", spotify_username: "", email: Faker::Internet.unique.email, description: Faker::Lorem.paragraphs, image_url: Faker::LoremFlickr.image(size: "100x120", search_terms: ['face']), password: "kirakira12")
end
